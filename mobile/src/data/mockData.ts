import { Product, Category, Order, Customer, DeliveryBoy, ReturnRequest } from '@/src/types';
...
export const orders: Order[] = [
  {
    orderId: 'ORD-001', customerId: 'c-1', customerName: 'Ramesh Kumar', customerMobile: '9876543210',
    items: [
  ...
  {
    orderId: 'ORD-002', customerId: 'c-2', customerName: 'Lakshmi Devi', customerMobile: '9876543211',
    items: [
  ...
  {
    orderId: 'ORD-003', customerId: 'c-3', customerName: 'Suresh Reddy', customerMobile: '9876543212',
    items: [
  ...
  {
    orderId: 'ORD-004', customerId: 'c-1', customerName: 'Ramesh Kumar', customerMobile: '9876543210',
    items: [
  ...
  {
    orderId: 'ORD-005', customerId: 'c-4', customerName: 'Priya Sharma', customerMobile: '9876543213',
    items: [
  ...
  {
    orderId: 'ORD-006', customerId: 'c-5', customerName: 'Venkat Rao', customerMobile: '9876543214',
    items: [
  ...
  {
    orderId: 'ORD-007', customerId: 'c-2', customerName: 'Lakshmi Devi', customerMobile: '9876543211',
    items: [
  ...
  {
    orderId: 'ORD-008', customerId: 'c-3', customerName: 'Suresh Reddy', customerMobile: '9876543212',
    items: [
